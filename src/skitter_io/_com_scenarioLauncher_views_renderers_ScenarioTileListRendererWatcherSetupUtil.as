package
{
   ...
   public class _com_scenarioLauncher_views_renderers_ScenarioTileListRendererWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
   {
       
      
      public function _com_scenarioLauncher_views_renderers_ScenarioTileListRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ScenarioTileListRenderer.watcherSetupUtil = new _com_scenarioLauncher_views_renderers_ScenarioTileListRendererWatcherSetupUtil();
      }
