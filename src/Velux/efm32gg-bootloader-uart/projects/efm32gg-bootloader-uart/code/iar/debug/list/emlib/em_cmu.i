...
static void setHfLeConfig(uint32_t hfFreq)
{
  ...
  hfleWs = 1;
  if (hfFreq <= maxFreqHfle()) {
    hfleWs = 0;
    hflePresc = 0;
  } else if (hfFreq <= (2UL * maxFreqHfle())) {
    hflePresc = 1;
  } else {
    hflePresc = 2;
  }
  BUS_RegBitWrite(&((CMU_TypeDef *) (0x400C8000UL))->CTRL, 30, hfleWs);
  ((CMU_TypeDef *) (0x400C8000UL))->HFCORECLKDIV = (((CMU_TypeDef *) (0x400C8000UL))->HFCORECLKDIV & ~0x100UL)
                           | (hflePresc << 8);
}
...
{
  uint32_t ws = BUS_RegBitRead(&((CMU_TypeDef *) (0x400C8000UL))->CTRL, 30);
  return ws;
}
...
static uint32_t auxClkGet(void)
{
  ...
  switch (((CMU_TypeDef *) (0x400C8000UL))->AUXHFRCOCTRL & 0x700UL) {
    case (0x00000003UL << 8):
...
static void flashWaitStateControl(uint32_t coreFreq, int vscale)
{
  ...
  mode = ((MSC_TypeDef *) (0x400C0000UL))->READCTRL & 0x7UL;
  ...
  if (0) {
    ...
    mode = (scbtpEn ? (0x00000005UL << 0) : (0x00000004UL << 0));
  }
  else if ((coreFreq <= 32000000) && (coreFreq > 16000000)) {
    mode = (scbtpEn ? (0x00000003UL << 0) : (0x00000001UL << 0));
  } else {
    mode = (scbtpEn ? (0x00000002UL << 0) : (0x00000000UL << 0));
  }
  ...
  ((MSC_TypeDef *) (0x400C0000UL))->READCTRL = (((MSC_TypeDef *) (0x400C0000UL))->READCTRL & ~0x7UL) | mode;
}
...
static void flashWaitStateMax(void)
{
  ...
  _Bool mscLocked = ((MSC_TypeDef *) (0x400C0000UL))->LOCK != 0UL;
  ((MSC_TypeDef *) (0x400C0000UL))->LOCK = 0x1B71;

  flashWaitStateControl(SystemMaxCoreClockGet(), 0);

  if (mscLocked) {
    ((MSC_TypeDef *) (0x400C0000UL))->LOCK = 0;
  }
}
...
static uint32_t lfClkGet(CMU_Clock_TypeDef lfClkBranch)
{
  ...
  switch (lfClkBranch) {
    case cmuClock_LFA:
      sel = (((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL & 0x3UL) >> 0;
      break;

    case cmuClock_LFB:
      sel = (((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL & 0xCUL) >> 2;
      break;
  ...
  switch (sel) {
    ...
    case 0x00000000UL:
      ...
      if ((lfClkBranch == cmuClock_LFA) || (lfClkBranch == cmuClock_LFB)) {
        if (((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL >> (lfClkBranch == cmuClock_LFA
                              ? 16
                              : 20)) {
...
static inline void syncReg(uint32_t mask)
{
   
   
  if ((((CMU_TypeDef *) (0x400C8000UL))->FREEZE & (0x1UL << 0)) != 0UL) {
    return;
  }

   
   
  while ((((CMU_TypeDef *) (0x400C8000UL))->SYNCBUSY & mask) != 0UL) {
  }
}
...
CMU_AUXHFRCOBand_TypeDef CMU_AUXHFRCOBandGet(void)
{
  return (CMU_AUXHFRCOBand_TypeDef)((((CMU_TypeDef *) (0x400C8000UL))->AUXHFRCOCTRL
                                     & 0x700UL)
                                    >> 8);
}
...
void CMU_AUXHFRCOBandSet(CMU_AUXHFRCOBand_TypeDef band)
{
  ...
  switch (band) {
    case cmuAUXHFRCOBand_1MHz:
      tuning = (((DEVINFO_TypeDef *) (0x0FE081B0UL))->AUXHFRCOCAL0 & 0x000000FFUL)
               >> 0;
      break;

    case cmuAUXHFRCOBand_7MHz:
      tuning = (((DEVINFO_TypeDef *) (0x0FE081B0UL))->AUXHFRCOCAL0 & 0x0000FF00UL)
               >> 8;
      break;

    case cmuAUXHFRCOBand_11MHz:
      tuning = (((DEVINFO_TypeDef *) (0x0FE081B0UL))->AUXHFRCOCAL0 & 0x00FF0000UL)
               >> 16;
      break;

    case cmuAUXHFRCOBand_14MHz:
      tuning = (((DEVINFO_TypeDef *) (0x0FE081B0UL))->AUXHFRCOCAL0 & 0xFF000000UL)
               >> 24;
      break;

    case cmuAUXHFRCOBand_21MHz:
      tuning = (((DEVINFO_TypeDef *) (0x0FE081B0UL))->AUXHFRCOCAL1 & 0x000000FFUL)
               >> 0;
      break;

    case cmuAUXHFRCOBand_28MHz:
      tuning = (((DEVINFO_TypeDef *) (0x0FE081B0UL))->AUXHFRCOCAL1 & 0x0000FF00UL)
               >> 8;
      break;
  ...
  ((CMU_TypeDef *) (0x400C8000UL))->AUXHFRCOCTRL = (((CMU_TypeDef *) (0x400C8000UL))->AUXHFRCOCTRL
                       & ~(0x700UL
                           | 0xFFUL))
                      | (band << 8)
                      | (tuning << 0);
...
uint32_t CMU_Calibrate(uint32_t HFCycles, CMU_Osc_TypeDef reference)
{
  ...
  while (BUS_RegBitRead(&((CMU_TypeDef *) (0x400C8000UL))->STATUS, 14) != 0UL) {
  }
                         ...
                         CMU_Osc_TypeDef upSel)
{
  ...
  uint32_t calCtrl = ((CMU_TypeDef *) (0x400C8000UL))->CALCTRL
                     & ~(0x7UL | 0x38UL);

   
  ((void)(downCycles <= (0xFFFFFUL >> 0)));

   
  switch (downSel) {
    case cmuOsc_LFXO:
      calCtrl |= (0x00000002UL << 3);
      break;

    case cmuOsc_LFRCO:
      calCtrl |= (0x00000004UL << 3);
      break;


    case cmuOsc_HFXO:
      calCtrl |= (0x00000001UL << 3);
      break;

    case cmuOsc_HFRCO:
      calCtrl |= (0x00000003UL << 3);
      break;

    case cmuOsc_AUXHFRCO:
      calCtrl |= (0x00000005UL << 3);
      break;
  ...
  ((CMU_TypeDef *) (0x400C8000UL))->CALCNT = downCycles;

   
  switch (upSel) {
    case cmuOsc_LFXO:
      calCtrl |= (0x00000001UL << 0);
      break;

    case cmuOsc_LFRCO:
      calCtrl |= (0x00000003UL << 0);
      break;


    case cmuOsc_HFXO:
      calCtrl |= (0x00000000UL << 0);
      break;

    case cmuOsc_HFRCO:
      calCtrl |= (0x00000002UL << 0);
      break;

    case cmuOsc_AUXHFRCO:
      calCtrl |= (0x00000004UL << 0);
      break;
  ...
  ((CMU_TypeDef *) (0x400C8000UL))->CALCTRL = calCtrl;
}
...
uint32_t CMU_CalibrateCountGet(void)
{
  ...
  if (BUS_RegBitRead(&((CMU_TypeDef *) (0x400C8000UL))->CALCTRL, 6) == 0UL) {
...
CMU_ClkDiv_TypeDef CMU_ClockDivGet(CMU_Clock_TypeDef clock)
{
  ...
  divReg = (clock >> 4U) & 0xfU;

  switch (divReg) {
    case 1:
      ret = 1 + ((((CMU_TypeDef *) (0x400C8000UL))->CTRL & 0x1C000UL)
                 >> 14);
      break;
    ...
    case 8:
      switch (clock) {
        ...
        case cmuClock_LETIMER0:
          ret = (CMU_ClkDiv_TypeDef)((((CMU_TypeDef *) (0x400C8000UL))->LFAPRESC0 & 0xF00UL)
                                     >> 8);
          ret = SL_Log2ToDiv(ret);
          break;
        ...
        case cmuClock_LESENSE:
          ret = (CMU_ClkDiv_TypeDef)((((CMU_TypeDef *) (0x400C8000UL))->LFAPRESC0 & 0x3UL)
                                     >> 0);
          ret = SL_Log2ToDiv(ret);
          break;
...
void CMU_ClockDivSet(CMU_Clock_TypeDef clock, CMU_ClkDiv_TypeDef div)
{
  ...
  switch (divReg) {
    case 1:
      ...
      ((CMU_TypeDef *) (0x400C8000UL))->CTRL = (((CMU_TypeDef *) (0x400C8000UL))->CTRL & ~0x1C000UL)
                  | ((div - 1) << 14);
    ...
    case 13:
      ...
      ((CMU_TypeDef *) (0x400C8000UL))->HFCORECLKDIV = (((CMU_TypeDef *) (0x400C8000UL))->HFCORECLKDIV
                           & ~0x100UL)
                          | (div << 8);
      break;
    ...
    case 8:
      switch (clock) {
        ...
        case cmuClock_LETIMER0:
          ...
          ((CMU_TypeDef *) (0x400C8000UL))->LFAPRESC0 = (((CMU_TypeDef *) (0x400C8000UL))->LFAPRESC0 & ~0xF00UL)
                           | (div << 8);
          break;
        ...
        case cmuClock_LESENSE:
          ...
          ((CMU_TypeDef *) (0x400C8000UL))->LFAPRESC0 = (((CMU_TypeDef *) (0x400C8000UL))->LFAPRESC0 & ~0x3UL)
                           | (div << 0);
          break;
...
uint32_t CMU_ClockFreqGet(CMU_Clock_TypeDef clock)
{
  ...
  switch ((unsigned)clock & (0x1fU << 17U)) {
    case (0 << 17U):
      ret = SystemHFClockGet();
      break;
    ...
    case (11 << 17U):
      ret = lfClkGet(cmuClock_LFA);
      ret >>= (((CMU_TypeDef *) (0x400C8000UL))->LFAPRESC0 & 0xF00UL)
              >> 8;
      break;
    ...
    case (23 << 17U):
      ret = lfClkGet(cmuClock_LFA);
      ret >>= (((CMU_TypeDef *) (0x400C8000UL))->LFAPRESC0 & 0x3UL)
              >> 0;
      break;
...
CMU_Select_TypeDef CMU_ClockSelectGet(CMU_Clock_TypeDef clock)
{
  ...
  selReg = ((unsigned)clock >> 0U) & 0xfU;

  switch (selReg) {
    case 1:
      switch (((CMU_TypeDef *) (0x400C8000UL))->STATUS
              & ((0x1UL << 10)
                 | (0x1UL << 11)
                 | (0x1UL << 12)
                 | (0x1UL << 13))) {
    ...
    case 2:
      switch (((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL & 0x3UL) {
        ...
        default:
          if (((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL & 0x10000UL) {
    ...
    case 3:
      switch (((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL & 0xCUL) {
        ...
        default:
          if (((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL & 0x100000UL) {
            ret = cmuSelect_ULFRCO;
            break;
          }
          break;
    ...
    case 6:
      switch (((CMU_TypeDef *) (0x400C8000UL))->CTRL & 0x10000000UL) {
        case (0x00000000UL << 28):
          ret = cmuSelect_AUXHFRCO;
          break;

        case (0x00000001UL << 28):
          ret = cmuSelect_HFCLK;
          break;
      }
      break;
...
void CMU_ClockSelectSet(CMU_Clock_TypeDef clock, CMU_Select_TypeDef ref)
{
  ...
  selRegId = ((unsigned)clock >> 0U) & 0xfU;
    ...
    case 1:
      switch (ref) {
        ...
        case cmuSelect_HFXO:
          ...
          setHfLeConfig(maxFreqHfle() + 1UL);
           
          if (SystemHFXOClockGet() > 32000000) {
            ((CMU_TypeDef *) (0x400C8000UL))->CTRL = (((CMU_TypeDef *) (0x400C8000UL))->CTRL & ~0x60UL)
                        | (0x00000003UL << 5);
          } else {
            ((CMU_TypeDef *) (0x400C8000UL))->CTRL = (((CMU_TypeDef *) (0x400C8000UL))->CTRL & ~0x60UL)
                        | (0x00000001UL << 5);
    ...
    case 3:
      switch (ref) {
        ...
        case cmuSelect_HFCLKLE:
          ...
          BUS_RegBitWrite(&((CMU_TypeDef *) (0x400C8000UL))->HFCORECLKEN0, 4, 1);
          tmp = 0x00000003UL;
          break;
      ...
      if (selRegId == 2) {
        ((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL = (((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL
                         & ~(0x3UL | 0x10000UL))
                        | (tmp << 0)
                        | (lfExtended << 16);
      } else {
    ...
    case 6:
      switch (ref) {
        ...
        case cmuSelect_AUXHFRCO:
          ...
          ((CMU_TypeDef *) (0x400C8000UL))->CTRL = (((CMU_TypeDef *) (0x400C8000UL))->CTRL & ~(0x10000000UL))
                      | (0x00000000UL << 28);
          break;
...
void CMU_FreezeEnable(_Bool enable)
{
  if (enable) {
    ...
    while (((CMU_TypeDef *) (0x400C8000UL))->SYNCBUSY != 0UL) {
    }
...
void CMU_HFXOInit(const CMU_HFXOInit_TypeDef *hfxoInit)
{
  ...
  ((void)(CMU_ClockSelectGet(cmuClock_HF) != cmuSelect_HFXO));

   
  CMU_OscillatorEnable(cmuOsc_HFXO, 0, 1);

  ((CMU_TypeDef *) (0x400C8000UL))->CTRL = (((CMU_TypeDef *) (0x400C8000UL))->CTRL & ~(0x600UL
                             | 0xCUL
                             | 0x3UL
                             | 0x80UL))
              | (hfxoInit->timeout << 9)
              | (hfxoInit->boost << 2)
              | (hfxoInit->mode << 0)
              | (hfxoInit->glitchDetector ? (0x1UL << 7) : 0);
}
...
void CMU_LFXOInit(const CMU_LFXOInit_TypeDef *lfxoInit)
{
  ...
  ((void)(CMU_ClockSelectGet(cmuClock_HF) != cmuSelect_LFXO));

   
  CMU_OscillatorEnable(cmuOsc_LFXO, 0, 1);

  _Bool cmuBoost  = (lfxoInit->boost & 0x2);
  BUS_RegMaskedWrite(&((CMU_TypeDef *) (0x400C8000UL))->CTRL,
                     0xC0000UL
                     | 0x2000UL
                     | 0x1800UL,
                     ((uint32_t)lfxoInit->timeout
                      << 18)
                     | ((cmuBoost ? 1 : 0) << 13)
                     | ((uint32_t)lfxoInit->mode << 11));
   
  _Bool emuReduce = (lfxoInit->boost & 0x1);
  BUS_RegBitWrite(&((EMU_TypeDef *) (0x400C6000UL))->AUXCTRL, 8, emuReduce ? 1 : 0);
}
...
void CMU_OscillatorEnable(CMU_Osc_TypeDef osc, _Bool enable, _Bool wait)
{
  ...
  if (enable) {
    ...
    if (wait) {
      while (BUS_RegBitRead(&((CMU_TypeDef *) (0x400C8000UL))->STATUS, rdyBitPos) == 0UL) {
      }
    }
  } else {
...
void CMU_OscillatorTuningSet(CMU_Osc_TypeDef osc, uint32_t val)
{
  ...
  switch (osc) {
    ...
    case cmuOsc_AUXHFRCO:
      ((void)(val <= (0xFFUL >> 0)));
      val &= (0xFFUL >> 0);
      ((CMU_TypeDef *) (0x400C8000UL))->AUXHFRCOCTRL = (((CMU_TypeDef *) (0x400C8000UL))->AUXHFRCOCTRL & ~(0xFFUL))
                          | (val << 0);
      break;
...
void CMU_PCNTClockExternalSet(unsigned int instance, _Bool external)
{
  ...
  ((void)(instance < (unsigned)3));

  if (external) {
    setting = 1;
  }

  BUS_RegBitWrite(&(((CMU_TypeDef *) (0x400C8000UL))->PCNTCTRL), (instance * 2U) + 1U, setting);
