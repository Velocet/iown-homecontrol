...
static volatile _Bool          aesFinished;
...
void AES_IRQHandler(void)
{
  ...
  ((AES_TypeDef *) (0x400E0000UL))->IFC = (0x1UL << 0);
  ...
  {    
    ...
    for (i = 3; i >= 0; i--)
    {
      outputDataG[i] = __iar_builtin_REV(((AES_TypeDef *) (0x400E0000UL))->DATA) ^ inputDataG[i];
    }
    outputDataG += 4;
    inputDataG  += 4;
    ...
    for (i = 3; i >= 0; i--)
    {
      ((AES_TypeDef *) (0x400E0000UL))->DATA = __iar_builtin_REV(ctrG[i]);
    }
  }
                         ...
                         _Bool initDecryption                  )
{
  ...
  if(initDecryption)
  {
    ...
    ((AES_TypeDef *) (0x400E0000UL))->IFC = (0x1UL << 0);
    ((AES_TypeDef *) (0x400E0000UL))->IEN = (0x1UL << 0);
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[(((uint32_t)(int32_t)AES_IRQn) >> 5UL)] = (uint32_t)(1UL << (((uint32_t)(int32_t)AES_IRQn) & 0x1FUL));
    ...
    for (i = 3; i >= 0; i--)
    {
      ((AES_TypeDef *) (0x400E0000UL))->KEYHA = __iar_builtin_REV(key32[i]);
    }
  }
