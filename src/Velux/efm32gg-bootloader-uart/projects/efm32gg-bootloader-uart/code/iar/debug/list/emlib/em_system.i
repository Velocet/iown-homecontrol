...
void SYSTEM_ChipRevisionGet(SYSTEM_ChipRevision_TypeDef *rev)
{
  ...
  tmp  = (uint8_t)(((((ROMTABLE_TypeDef *) (0xE00FFFD0UL))->PID1 & 0x0000000FUL)
                    >> 0) << 2);
   
  tmp |=  (uint8_t)((((ROMTABLE_TypeDef *) (0xE00FFFD0UL))->PID0 & 0x000000C0UL)
                    >> 6);
  rev->family = tmp;

   
  rev->major = (uint8_t)((((ROMTABLE_TypeDef *) (0xE00FFFD0UL))->PID0 & 0x0000003FUL)
                         >> 0);

   
  tmp  = (uint8_t)(((((ROMTABLE_TypeDef *) (0xE00FFFD0UL))->PID2 & 0x000000F0UL)
                    >> 4) << 4);
   
  tmp |= (uint8_t)((((ROMTABLE_TypeDef *) (0xE00FFFD0UL))->PID3 & 0x000000F0UL)
                   >> 4);
  rev->minor = tmp;
}
...
_Bool SYSTEM_GetCalibrationValue(volatile uint32_t *regAddress)
{
  ...
  p   = (SYSTEM_CalAddrVal_TypeDef *)((0x0FE081B0UL) & 0xFFFFF000U);
  end = (SYSTEM_CalAddrVal_TypeDef *)(0x0FE081B0UL);
