...
__ramfunc void XMODEM_download(uint32_t baseAddress, uint32_t endAddress, _Bool encrypted);
...
_Bool BOOT_checkFirmwareIsValid(void);
...
__ramfunc _Bool DEBUGLOCK_lock(void);
...
_Bool resetEFM32onRTCTimeout = 0;
...
void RTC_IRQHandler(void)
{
  ((RTC_TypeDef *) (0x40080000UL))->IFC = (0x1UL << 2) | (0x1UL << 1) | (0x1UL << 0);                  
...
static void waitForBootOrUSART(void)
{
  ...
  ((RTC_TypeDef *) (0x40080000UL))->IFC = (0x1UL << 2) | (0x1UL << 1) | (0x1UL << 0);                    
  ((RTC_TypeDef *) (0x40080000UL))->COMP0 = (((250) * (32768)) / 1000); 
  ((RTC_TypeDef *) (0x40080000UL))->IEN = (0x1UL << 1);                   
  __NVIC_EnableIRQ(RTC_IRQn);            
  ((RTC_TypeDef *) (0x40080000UL))->CTRL = (0x1UL << 2) | (0x1UL << 1) | (0x1UL << 0);                        
  ...
  while (1)
  {
	...
	SWDpins = ((GPIO_TypeDef *) (0x40006000UL))->P[5].DIN & 0x1;
	...
	if (SWDpins == 0x1)
	{
	  ...
	  ((RTC_TypeDef *) (0x40080000UL))->COMP0 = ((30) * (32768));
	  
	  
	  resetEFM32onRTCTimeout = 1;
...
{   
  ...
  USART_printHex(((DEVINFO_TypeDef *) (0x0FE081B0UL))->UNIQUEH);
  USART_printHex(((DEVINFO_TypeDef *) (0x0FE081B0UL))->UNIQUEL);
  USART_printString(newLineString);
}
...
__ramfunc void debugLock(void)
{
	...
	static uint8_t debugActiveMsg[] = "Debug active.\r\n";
	  ...
	  if ((((CoreDebug_Type *) (0xE000EDF0UL))->DHCSR & (1UL )) != 0x0)
	  {
...
__ramfunc __noreturn void commandlineLoop(void)
{
  ...
  while (1)                                     
  {
	...
	case 0x75:                                   
	  ...
	  XMODEM_download((4*1024), flashSize, 0);
	  break;

	case 0x65:                                   
	  USART_printString(readyString);
	  XMODEM_download((4*1024), flashSize, 1);
	  break;

	case 0X74:                                   
	  USART_printString(readyString);
	  XMODEM_download((0x0FE00000), (0x0FE00200), 0);
	  break;

	case 0X70:                                   
	  DEBUGLOCK_startDebugInterface();
	  USART_printString(readyString);
	  XMODEM_download((0x0FE04000), (0x0FE04200), 0);
	  break;
	...
	case 0X63:             
	  verify((4*1024), flashSize);
	  break;

	case 0X6E:             
	  verify((0x0FE00000), (0x0FE00200));
	  break;

	case 0X6D:             
	  verify((0x0FE04000), (0x0FE04200));
	  break;
...
static void generateVectorTable(void)
{
  vectorTable[TIMER1_IRQn + 16] = (uint32_t) TIMER_IRQHandler;
  vectorTable[RTC_IRQn + 16]             = (uint32_t)RTC_IRQHandler;
  vectorTable[AES_IRQn + 16]             = (uint32_t)AES_IRQHandler;
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR                             = (uint32_t)vectorTable;
}
...
static void createBuildVersionArray()
{
  ...
  buildVersion[0] = stBuildVersion.bCommandVersionNumber;   
  buildVersion[1]   = stBuildVersion.bVersionWholeNumber;
  buildVersion[2]     = stBuildVersion.bVersionSubNumber;	
  buildVersion[3]              = stBuildVersion.bBranchID;	
  buildVersion[4]           = stBuildVersion.bBuildNumber;
  buildVersion[5]            = stBuildVersion.bMicroBuild;
...
__noreturn void main(void)
{
  ...
  bootloaderCRC  = CRC_calc((void *)(0),
							(void *)((0) + (4*1024)));
  bootloaderCRC |= CRC_calc((void *)((0x0FE081B0) + 2),
  ...
  ((CMU_TypeDef *) (0x400C8000UL))->HFPERCLKDIV = (0x1UL << 8);
  ((CMU_TypeDef *) (0x400C8000UL))->HFPERCLKEN0 = (0x1UL << 13) | (0x1UL << 0) |
					 (0x1UL << 6) ;

  
  ((CMU_TypeDef *) (0x400C8000UL))->HFCORECLKEN0 = (0x1UL << 4) | (0x1UL << 0);

  
  ((CMU_TypeDef *) (0x400C8000UL))->OSCENCMD = (0x1UL << 6);
  
  ((CMU_TypeDef *) (0x400C8000UL))->LFCLKSEL = (0x00000001UL << 0) | (0x00000003UL << 2);
  
  ((CMU_TypeDef *) (0x400C8000UL))->LFACLKEN0 = (0x1UL << 1);

  
  
  flashSize = ((((DEVINFO_TypeDef *) (0x0FE081B0UL))->MSIZE & 0x0000FFFFUL)
			   >> 0)
			  << 10;
  ...
  ((CMU_TypeDef *) (0x400C8000UL))->HFRCOCTRL = (0x00000005UL << 8) | tuning;
  
  ((USART_TypeDef *) (0x4000E400UL))->CLKDIV = 3634;
  ...
  if (clkdiv < 3000)
  {
	...
	((USART_TypeDef *) (0x4000C000UL))->CTRL |= (0x00000003UL << 5);
  }
