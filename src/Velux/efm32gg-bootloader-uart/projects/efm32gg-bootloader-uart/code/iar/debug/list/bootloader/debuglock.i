...
__ramfunc inline void _DEBUGLOCK_driveBit(int bit)
{
  int i;
  if (bit)
  {
     
    ((GPIO_TypeDef *) (0x40006000UL))->ROUTE |= (0x1UL << 1);
  }
  else
  {
  ...
  ((GPIO_TypeDef *) (0x40006000UL))->ROUTE |= (0x1UL << 0);
  ((GPIO_TypeDef *) (0x40006000UL))->P[5].MODEL = (0x00000001UL << 0);
   
  for (i=0; i < 1000; i++);
   
  ((GPIO_TypeDef *) (0x40006000UL))->ROUTE &= ~((0x1UL << 0));
  ((GPIO_TypeDef *) (0x40006000UL))->P[5].MODEL = (0x00000000UL << 0);
}
...
__ramfunc void DEBUGLOCK_startDebugInterface(void)
{
  ...
  ((GPIO_TypeDef *) (0x40006000UL))->P[5].MODEL = 0;
  ((GPIO_TypeDef *) (0x40006000UL))->ROUTE = 0;
...
__ramfunc _Bool DEBUGLOCK_lock(void)
{
  ...
  FLASH_writeWord((0x0FE04000 + (127 * 4)), 0x0);
   
  if (*(uint32_t *)(0x0FE04000 + (127 * 4)) == 0x0)
  {
    return 1;
  }
  return 0;
