...
const constants = {
    ...
    IMG_NAMES : {
        ...
        'connexoon'             : {            'default': 'Connexoon',            'icon': 'connexoon'        },
        'tahoma_v2'             : {            'default': 'TaHomaV2',            'icon': 'TaHomaV2Gateway'        },
        'tahoma'                : {            'default': 'TaHomaV2',            'icon': 'TaHomaV2Gateway'        },
        'tahoma_rail_din'       : {            'default': 'TaHomaRailDin',            'icon': 'TaHomaRailDinGateway'        },
        'tahoma_rail_din_dtc'   : {            'default': 'TaHomaRailDinDtc',            'icon': 'TaHomaRailDinDtcGateway'        },
        'tahoma_v1'             : {            'default': 'TaHomaV1',            'icon': 'TaHomaGateway'        },
        'tahoma_switch'         : {            'default': 'TaHomaSwitch',            'icon': 'TaHomaSwitch'        },
        'hub_tahoma_2'          : {            'default': 'TaHomaV2',            'icon': 'TaHomaV2Gateway'        },
        'hub_tahoma_1'          : {            'default': 'TaHomaV1',            'icon': 'TaHomaGateway'        },
        'home_secure_gateway'   : {            'default': 'HomeKeeper',            'icon': 'homekeeper'        },
        'hub_tahoma_raildin'    : {            'default': 'TaHomaRailDin',            'icon': 'TaHomaRailDinGateway'        },
        'hub_connexoon'         : {            'default': 'Connexoon',            'icon': 'connexoon'        },
        'hub_tahoma_switch'     : {            'default': 'TaHomaSwitch',            'icon': 'TaHomaSwitch'        },
        'hub_tahoma_raildin_dtc': {            'default': 'TaHomaRailDinDtc',            'icon': 'TaHomaRailDinDtcGateway'        },
        PROTOCOLS : {
            'io'         : 'io',
            'rts'        : 'rts',
            'rtd'        : 'rtd',
