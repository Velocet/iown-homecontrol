ProxyFrame {
  0 = COMMAND_SERVICE_ID__GIVE_VERSION             1 = COMMAND_SERVICE_ID__SUBSCRIBE_PRODUCT           2 = COMMAND_SERVICE_ID__GIVE_CONNECTED_DEVICES
  0 = COMMAND_SERVICE_STATUS_ID__DEVICE_CONNECTED  1 = COMMAND_SERVICE_STATUS_ID__DEVICE_DISCONNECTED  2 = COMMAND_SERVICE_STATUS_ID__DEVICES_DETECTION_FINISHED
...
PowerSaveMode {AlwaysAlive = 0,LowPowerMode = 1}
...
local function func_4504699139129346_runManufacturerSettingsCommand(p1,p2,p3,p4)
...
function splitActuatorType(value: number):
...
class SystemTableDataEntry {
    constructor(data: Buffer) {
        ...
        PowerSaveMode   =  byte6 & 0x03;            0b0000.0011
        ioMembership    = (byte6 & 0x04) === 0x04;  0b0000.0100
        RFSupport       = (byte6 & 0x08) === 0x08;     0b0000.1000
        switch (byte6 >>> 6) {
