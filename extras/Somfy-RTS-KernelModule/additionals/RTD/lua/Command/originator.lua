import("Overkiz.HomeAutomation.Protocol.RTD.Command.Originator")

local var_0_0 = Originator("/com/overkiz/Application/Lua/HomeAutomation/Protocol/RTD/Command/Originator")
