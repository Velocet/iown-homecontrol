...
/*
 * Define characters to be used for assignment because: 
 * MISRA 2004 Required Rule 6.2, Disallowed use of non-numeric value in the assignment to an object of a unsigned char type
 */
