...
void TIMER_IRQHandler(void)
{
  ...
  ((TIMER_TypeDef *) (0x40010400UL))->IFC = (0x1UL << 5);

   
  if (currentSample < 5)
  {
    period                 = ((TIMER_TypeDef *) (0x40010400UL))->CC[1].CCV;
...
int AUTOBAUD_estimatePeriod(void)
{
  uint32_t minimumPeriod = 0xffffffffU;
  uint32_t i;
...
int AUTOBAUD_sync(void)
{
  ...
  ((TIMER_TypeDef *) (0x40010400UL))->TOP = 0xffffffffU;

  
 
  ((TIMER_TypeDef *) (0x40010400UL))->CC[1].CTRL = (0x00000001UL << 0) |
                                            (0x00000000UL << 24);

   
  ((TIMER_TypeDef *) (0x40010400UL))->ROUTE = (0x00000001UL << 16) |
                   
                  (0x1UL << 1);

   
  ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[0] = (1 << TIMER1_IRQn) | (1 << GPIO_EVEN_IRQn);

   
  ((TIMER_TypeDef *) (0x40010400UL))->IEN = (0x1UL << 5);

   
  ((TIMER_TypeDef *) (0x40010400UL))->CMD = (0x1UL << 0);

   
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= ~(1UL << 2U);

   
  while (currentSample < 5)
  {
    __iar_builtin_WFI();
  }

   
  ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICER[0] = (1 << TIMER1_IRQn) | (1 << GPIO_EVEN_IRQn);

   
  ((TIMER_TypeDef *) (0x40010400UL))->ROUTE = 0x00000000UL;
