...
void FLASH_init(void)
{
  ...
  ((MSC_TypeDef *) (0x400C0000UL))->WRITECTRL |= (0x1UL << 0);

  ((DMA_TypeDef *) (0x400C2000UL))->CONFIG = (0x1UL << 0);          
  ((DMA_TypeDef *) (0x400C2000UL))->CTRLBASE = (uint32_t)&descr;     
}
...
__ramfunc void FLASH_writeWord(uint32_t adr, uint32_t data)
{
  ...
  ((MSC_TypeDef *) (0x400C0000UL))->ADDRB    = adr;                     
  ((MSC_TypeDef *) (0x400C0000UL))->WRITECMD = (0x1UL << 0);
  ((MSC_TypeDef *) (0x400C0000UL))->WDATA    = data;                    
  ((MSC_TypeDef *) (0x400C0000UL))->WRITECMD = (0x1UL << 3);  
  while (((MSC_TypeDef *) (0x400C0000UL))->STATUS & (0x1UL << 0));   
}
                                ...
                                uint8_t const *buffer)
{
  ...
  ((MSC_TypeDef *) (0x400C0000UL))->ADDRB    = (uint32_t)block_start + offset_into_block;
  ((MSC_TypeDef *) (0x400C0000UL))->WRITECMD = (0x1UL << 0);

  
  descr.DSTEND = (void *)&((MSC_TypeDef *) (0x400C0000UL))->WDATA;

  
  descr.SRCEND = (void *)(buffer + count - 4);

  
  descr.CTRL = 0xC0000000UL       
               | 0x20000000UL    
               | 0x08000000UL     
               | 0x02000000UL    
               | 0x00000000UL
  ...
  ((DMA_TypeDef *) (0x400C2000UL))->CH[0].CTRL = (0x00000030UL << 16)
                    | (0x00000000UL << 0);

  ((MSC_TypeDef *) (0x400C0000UL))->WDATA = *(uint32_t *)buffer;         
  ((DMA_TypeDef *) (0x400C2000UL))->CHENS = (0x1UL << 0);            
  ((MSC_TypeDef *) (0x400C0000UL))->WRITECMD = (0x1UL << 4);   
}
...
__ramfunc void FLASH_eraseOneBlock(uint32_t blockStart)
{
  ...
  if (acc != 0xFFFFFFFF)
  {
    ((MSC_TypeDef *) (0x400C0000UL))->ADDRB    = blockStart;               
    ((MSC_TypeDef *) (0x400C0000UL))->WRITECMD = (0x1UL << 0);
    ((MSC_TypeDef *) (0x400C0000UL))->WRITECMD = (0x1UL << 1);   
    while (((MSC_TypeDef *) (0x400C0000UL))->STATUS & (0x1UL << 0));    
  }
}
