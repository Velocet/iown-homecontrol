...
void DEBUG_init(void)
{
  ...
  ((CMU_TypeDef *) (0x400C8000UL))->HFPERCLKEN0 |= (0x1UL << 4);
  
 
  ((USART_TypeDef *) (0x4000E400UL))->CLKDIV = 1688;
  ((USART_TypeDef *) (0x4000E400UL))->ROUTE = (0x1UL << 0) | (0x1UL << 1)
					   | (0x00000002UL << 8);

   
  ((USART_TypeDef *) (0x4000E400UL))->CMD = (0x1UL << 11) | (0x1UL << 10);
   
  ((USART_TypeDef *) (0x4000E400UL))->CMD = (0x1UL << 0) | (0x1UL << 2);
...
int DEBUG_TxByte(uint8_t data)
{
  ...
  while (!(((USART_TypeDef *) (0x4000E400UL))->STATUS & (0x1UL << 6)));


  ((USART_TypeDef *) (0x4000E400UL))->TXDATA = (uint32_t)data;
  return (int)data;
}
