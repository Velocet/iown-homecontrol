...
static inline void AES_IntClear(uint32_t flags)
{
  ((AES_TypeDef *) (0x400E0000UL))->IFC = flags;
}
...
static inline void AES_IntDisable(uint32_t flags)
{
  ((AES_TypeDef *) (0x400E0000UL))->IEN &= ~(flags);
}
...
static inline void AES_IntEnable(uint32_t flags)
{
  ((AES_TypeDef *) (0x400E0000UL))->IEN |= flags;
}
...
static inline uint32_t AES_IntGet(void)
{
  return ((AES_TypeDef *) (0x400E0000UL))->IF;
}
...
static inline uint32_t AES_IntGetEnabled(void)
{
  uint32_t ien;

  ien = ((AES_TypeDef *) (0x400E0000UL))->IEN;
  return ((AES_TypeDef *) (0x400E0000UL))->IF & ien;
}
...
static inline void AES_IntSet(uint32_t flags)
{
  ((AES_TypeDef *) (0x400E0000UL))->IFS = flags;
}
                ...
                _Bool encrypt)
{
  ...
  uint32_t       prev[16 / sizeof(uint32_t)];
  ...
  for (i = 3; i >= 0; i--) {
    ((AES_TypeDef *) (0x400E0000UL))->KEYHA = __iar_builtin_REV(( ((uint32_t)((&key[i * 4])[3])) << 24 | ((uint32_t)((&key[i * 4])[2])) << 16 | ((uint32_t)((&key[i * 4])[1])) << 8 | ((uint32_t)((&key[i * 4])[0])) << 0));
  }

  if (encrypt) {
     
    ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 2) | (0x1UL << 5);

     
     
    for (i = 3; i >= 0; i--) {
      ((AES_TypeDef *) (0x400E0000UL))->DATA = __iar_builtin_REV(( ((uint32_t)((&iv[i * 4])[3])) << 24 | ((uint32_t)((&iv[i * 4])[2])) << 16 | ((uint32_t)((&iv[i * 4])[1])) << 8 | ((uint32_t)((&iv[i * 4])[0])) << 0));
    }
    ...
    while (len--) {
      ...
      for (i = 3; i >= 0; i--) {
        ((AES_TypeDef *) (0x400E0000UL))->XORDATA = __iar_builtin_REV(( ((uint32_t)((&in[i * 4])[3])) << 24 | ((uint32_t)((&in[i * 4])[2])) << 16 | ((uint32_t)((&in[i * 4])[1])) << 8 | ((uint32_t)((&in[i * 4])[0])) << 0));
      }
      in += 16;

       
      while (((AES_TypeDef *) (0x400E0000UL))->STATUS & (0x1UL << 0))
        ;

       
      for (i = 3; i >= 0; i--) {
        do { uint32_t valbuf = __iar_builtin_REV(((AES_TypeDef *) (0x400E0000UL))->DATA); (&out[i * 4])[3] = (valbuf >> 24) & 0xFFu; (&out[i * 4])[2] = (valbuf >> 16) & 0xFFu; (&out[i * 4])[1] = (valbuf >> 8) & 0xFFu; (&out[i * 4])[0] = (valbuf >> 0) & 0xFFu; } while (0);
      }
      out += 16;
    }
  } else {
     
    ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 0) | (0x1UL << 2) | (0x1UL << 4);
    ...
    while (len--) {
      ...
      for (i = 3; i >= 0; i--) {
        ((AES_TypeDef *) (0x400E0000UL))->DATA = __iar_builtin_REV(( ((uint32_t)((&in[i * 4])[3])) << 24 | ((uint32_t)((&in[i * 4])[2])) << 16 | ((uint32_t)((&in[i * 4])[1])) << 8 | ((uint32_t)((&in[i * 4])[0])) << 0));
      }
      ...
      for (i = 3; i >= 0; i--) {
        ((AES_TypeDef *) (0x400E0000UL))->XORDATA = __iar_builtin_REV(prev[i]);
      }
      memcpy(prev, in, 16);
      in += 16;
                ...
                _Bool encrypt)
{
  ...
  if (encrypt) {
    ...
    ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 1) | (0x1UL << 5);
    ...
    while (len--) {
      ...
      for (i = 3, j = 7; i >= 0; i--, j--) {
        ((AES_TypeDef *) (0x400E0000UL))->KEYLA = __iar_builtin_REV(( ((uint32_t)((&key[j * 4])[3])) << 24 | ((uint32_t)((&key[j * 4])[2])) << 16 | ((uint32_t)((&key[j * 4])[1])) << 8 | ((uint32_t)((&key[j * 4])[0])) << 0));
        ((AES_TypeDef *) (0x400E0000UL))->KEYHA = __iar_builtin_REV(( ((uint32_t)((&key[i * 4])[3])) << 24 | ((uint32_t)((&key[i * 4])[2])) << 16 | ((uint32_t)((&key[i * 4])[1])) << 8 | ((uint32_t)((&key[i * 4])[0])) << 0));
    ...
    ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 1) | (0x1UL << 0) | (0x1UL << 4);
                ...
                _Bool encrypt)
{
  ...
  ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 2) | (0x1UL << 4);
  ...
  while (len--) {
    ...
    for (i = 3; i >= 0; i--) {
      ((AES_TypeDef *) (0x400E0000UL))->DATA = __iar_builtin_REV(( ((uint32_t)((&data[i * 4])[3])) << 24 | ((uint32_t)((&data[i * 4])[2])) << 16 | ((uint32_t)((&data[i * 4])[1])) << 8 | ((uint32_t)((&data[i * 4])[0])) << 0));
    }
    ...
    for (i = 3; i >= 0; i--) {
      do { uint32_t valbuf = __iar_builtin_REV(((AES_TypeDef *) (0x400E0000UL))->DATA) ^ ( ((uint32_t)((&in[i * 4])[3])) << 24 | ((uint32_t)((&in[i * 4])[2])) << 16 | ((uint32_t)((&in[i * 4])[1])) << 8 | ((uint32_t)((&in[i * 4])[0])) << 0); (&out[i * 4])[3] = (valbuf >> 24) & 0xFFu; (&out[i * 4])[2] = (valbuf >> 16) & 0xFFu; (&out[i * 4])[1] = (valbuf >> 8) & 0xFFu; (&out[i * 4])[0] = (valbuf >> 0) & 0xFFu; } while (0);
    }
    out += 16;
    in  += 16;
  }
                ...
                _Bool encrypt)
{
  ...
  ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 1) | (0x1UL << 4);
                ...
                AES_CtrFuncPtr_TypeDef ctrFunc)
{
  ...
  while (len--) {
    ...
    for (i = 3; i >= 0; i--) {
      ((AES_TypeDef *) (0x400E0000UL))->DATA = __iar_builtin_REV(( ((uint32_t)((&ctr[i * 4])[3])) << 24 | ((uint32_t)((&ctr[i * 4])[2])) << 16 | ((uint32_t)((&ctr[i * 4])[1])) << 8 | ((uint32_t)((&ctr[i * 4])[0])) << 0));
    }
...
void AES_CTRUpdate32Bit(uint8_t *ctr)
{
  do { uint32_t valbuf = __iar_builtin_REV(__iar_builtin_REV(( ((uint32_t)((&ctr[12])[3])) << 24 | ((uint32_t)((&ctr[12])[2])) << 16 | ((uint32_t)((&ctr[12])[1])) << 8 | ((uint32_t)((&ctr[12])[0])) << 0)) + 1); (&ctr[12])[3] = (valbuf >> 24) & 0xFFu; (&ctr[12])[2] = (valbuf >> 16) & 0xFFu; (&ctr[12])[1] = (valbuf >> 8) & 0xFFu; (&ctr[12])[0] = (valbuf >> 0) & 0xFFu; } while (0);
}
...
void AES_DecryptKey128(uint8_t *out, const uint8_t *in)
{
  ...
  for (i = 3; i >= 0; i--) {
    ((AES_TypeDef *) (0x400E0000UL))->KEYLA = __iar_builtin_REV(( ((uint32_t)((&in[i * 4])[3])) << 24 | ((uint32_t)((&in[i * 4])[2])) << 16 | ((uint32_t)((&in[i * 4])[1])) << 8 | ((uint32_t)((&in[i * 4])[0])) << 0));
  }

   
  ((AES_TypeDef *) (0x400E0000UL))->CTRL = 0;
  AES_IntClear((0x1UL << 0));
  ((AES_TypeDef *) (0x400E0000UL))->CMD = (0x1UL << 0);
  ...
  for (i = 3; i >= 0; i--) {
    do { uint32_t valbuf = __iar_builtin_REV(((AES_TypeDef *) (0x400E0000UL))->KEYLA); (&out[i * 4])[3] = (valbuf >> 24) & 0xFFu; (&out[i * 4])[2] = (valbuf >> 16) & 0xFFu; (&out[i * 4])[1] = (valbuf >> 8) & 0xFFu; (&out[i * 4])[0] = (valbuf >> 0) & 0xFFu; } while (0);
  }
}
...
void AES_DecryptKey256(uint8_t *out, const uint8_t *in)
{
  ...
  for (i = 3, j = 7; i >= 0; i--, j--) {
    ((AES_TypeDef *) (0x400E0000UL))->KEYLA = __iar_builtin_REV(( ((uint32_t)((&in[j * 4])[3])) << 24 | ((uint32_t)((&in[j * 4])[2])) << 16 | ((uint32_t)((&in[j * 4])[1])) << 8 | ((uint32_t)((&in[j * 4])[0])) << 0));
    ((AES_TypeDef *) (0x400E0000UL))->KEYHA = __iar_builtin_REV(( ((uint32_t)((&in[i * 4])[3])) << 24 | ((uint32_t)((&in[i * 4])[2])) << 16 | ((uint32_t)((&in[i * 4])[1])) << 8 | ((uint32_t)((&in[i * 4])[0])) << 0));
  }

   
  ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 1);
  ((AES_TypeDef *) (0x400E0000UL))->CMD  = (0x1UL << 0);
  ...
  for (i = 3, j = 7; i >= 0; i--, j--) {
    do { uint32_t valbuf = __iar_builtin_REV(((AES_TypeDef *) (0x400E0000UL))->KEYLA); (&out[j * 4])[3] = (valbuf >> 24) & 0xFFu; (&out[j * 4])[2] = (valbuf >> 16) & 0xFFu; (&out[j * 4])[1] = (valbuf >> 8) & 0xFFu; (&out[j * 4])[0] = (valbuf >> 0) & 0xFFu; } while (0);
    do { uint32_t valbuf = __iar_builtin_REV(((AES_TypeDef *) (0x400E0000UL))->KEYHA); (&out[i * 4])[3] = (valbuf >> 24) & 0xFFu; (&out[i * 4])[2] = (valbuf >> 16) & 0xFFu; (&out[i * 4])[1] = (valbuf >> 8) & 0xFFu; (&out[i * 4])[0] = (valbuf >> 0) & 0xFFu; } while (0);
  }
}
                ...
                _Bool encrypt)
{
  ...
  if (encrypt) {
    ...
    ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 0) | (0x1UL << 1) | (0x1UL << 4);
  }
                ...
                const uint8_t *iv)
{
  ...
  ((AES_TypeDef *) (0x400E0000UL))->CTRL = (0x1UL << 2);
