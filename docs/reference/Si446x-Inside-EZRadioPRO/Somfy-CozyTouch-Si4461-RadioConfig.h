/*!
 *
 * @file io-homecontrol-stm32-radio_config.h
 * @brief This file contains the register configurations for the Si4461 as used with the io-homecontrol firmware.
 *
 * @n Device: Si4461 Rev.: C2
 *
 * @b COPYRIGHT
 * @n iown-homecontrol
 * @n Copyright 2024 iown-homecontrol
 * @n https://github.com/velocet/iown-homecontrol
 *
 * The following data was extracted from the io-homecontrol firmware (STM32F103 based) from a Cozytouch device which sports a Si4461 radio.
 * Sadly SiliconLabs has no option to read those values and translate them into a human readable format to understand them.
 * If you are feeling brave enought and can decipher the values and their dependencies this would help a lot!
 *
 * This config file was created by setting all known io-homecontrol radio values and then exporting this header file.
 * This means that only the values inside this block comment are from the io-homecontrol firmware.
 * The rest is just standard WDS but can be used as a base.
 *
 * SIZE ADDR DATA
 *  3F  0000 00...
 *
 * # CONFIG
 * 06 01 00 01 8C BA 80                            # 0x02 POWER_UP
 * 06 04 14 21 20 18 00                            # 0x13 GPIO_PIN_CFG: Version 1
 * 06 18 02 14 04 18 00                            # 0x13 GPIO_PIN_CFG: Version 1: Debug
 * 06 04 14 21 20 1B 00                            # 0x13 GPIO_PIN_CFG: Version 2
 * 06 22 03 01 50 00 3D                            # 0x13 GPIO_PIN_CFG: Version 3
 * 03 00 00 00                                     # 0x20 GET_INT_STATUS
 * 01 00                                           # 0x22 GET_MODEM_STATUS
 * 04 00 00 00 15                                  # 0x31 START_TX
 * 04 00 00 FF FF                                  # 0x32 START_RX
 * 01 01                                           # 0x34 CHANGE_STATE: SLEEP
 * 01 02                                           # 0x34 CHANGE_STATE: SPI_ACTIVE
 * 01 03                                           # 0x34 CHANGE_STATE: READY
 *
 * 04 20 01 4A FF                                  # 0xxx SET_PROPERTY or START_TX/RX (unsure)
 * 04 20 01 4A 4A                                  # 0xxx SET_PROPERTY or START_TX/RX (unsure)
 *
 * # GLOBAL (0x00)
 * 04 00 01 01 00                                  # 0x11 SET_PROPERTY: GLOBAL_CLK_CFG = 32kHz clock is driven by internal RC oscillator
 * 04 00 01 01 01                                  # 0x11 SET_PROPERTY: GLOBAL_CLK_CFG
 * 04 00 01 04 42                                  # 0x11 SET_PROPERTY: GLOBAL_CLK_CFG
 * 07 00 04 00 2E 01 18 40                         # 0x11 SET_PROPERTY:
 * 08 00 05 05 00 7B 20 0A 01                      # 0x11 SET_PROPERTY: GLOBAL_WUT
 * 09 00 06 04 00 00 01 60 00 00                   # 0x11 SET_PROPERTY: GLOBAL_WUT
 *
 * # INT_CTL (0x01)
 * 04 01 01 00 00                                  # 0x11 SET_PROPERTY:
 *
 * # FRR_CTL (0x02)
 * 07 02 04 00 00 00 00 00                         # 0x11 SET_PROPERTY:
 *
 * # PREAMBLE (0x10)
 * 04 10 01 01 98                                  # 0x11 SET_PROPERTY:
 * 04 10 01 01 A0                                  # 0x11 SET_PROPERTY:
 *
 * # MODEM (0x20)
 * 06 20 03 0A 00 03 27                            # 0x11 SET_PROPERTY:
 * 05 20 02 1E 20 20                               # 0x11 SET_PROPERTY:
 * 0C 20 09 22 00 55 06 0C AB 05 C8 02 00          # 0x11 SET_PROPERTY:
 * 0D 20 0A 00 8A 00 07 00 96 00 00 27 AC 40       # 0x11 SET_PROPERTY: Version 1: Normal
 * 0D 20 0A 00 EA 00 07 00 96 00 00 27 AC 40       # 0x11 SET_PROPERTY: Version 1: Debug
 * 0D 20 0A 2C 00 12 80 C2 02 43 E0 00 00 E2       # 0x11 SET_PROPERTY: Version 2: Unknown
 * 0D 20 0A 00 88 00 07 00 96 00 00 27 AC 40       # 0x11 SET_PROPERTY: Version 3: Unknown
 * 0F 20 0C 38 11 13 13 00 02 42 AB 00 28 0C A4 03 # 0x11 SET_PROPERTY:
 * 0E 20 0B 44 D6 03 01 89 01 80 FF 0C 00 00 40    # 0x11 SET_PROPERTY:
 *
 * # MODEM_CHFLT (0x21)
 * 0F 21 0C 00 FF BA 0F 51 CF A9 C9 FC 1B 1E 0F 01 # 0x11 SET_PROPERTY:
 * 0F 21 0C 0C FC FD 15 FF 00 0F FF BA 0F 51 CF A9 # 0x11 SET_PROPERTY:
 * 0F 21 0C 18 C9 FC 1B 1E 0F 01 FC FD 15 FF 00 0F # 0x11 SET_PROPERTY:
 *
 * # PA (0x22)
 * 06 22 03 01 50 00 3D                            # 0x11 SET_PROPERTY:
 * 0A 23 07 00 2B 0D 06 06 0F 7F 03                # 0x11 SET_PROPERTY:
 *
 * # FREQ_CONTROL (0x40)
 * 09 40 06 00 41 0E 4E C4 27 62                   # 0x11 SET_PROPERTY:
 *
 * 0E 4E C4 # Channel 1
 * 0E BD 0B # Channel 2
 * 0F 4A D4 # Channel 3
...
// MOD_type: 2    Rsymb(sps): 38400    Fdev(Hz): 19200    RXBW(Hz): 150000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2
// RF Freq.(MHz): 868.95    API_TC: 29    fhst: 25000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1
// API_ARR_Det_en: 0    Fdev_error: 0    API_ETSI: 0
//
// # RX IF frequency is  -406250 Hz
// # WB filter 1 (BW =  99.20 kHz);  NB-filter 3 (BW = 80.26 kHz)
//
// Modulation index: 1
*/
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x13, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x41, 0x08, 0x80, 0x00, 0x03, 0xF0, 0x20, 0xFF
...
*/
#define RF_INT_CTL_ENABLE_1 0x11, 0x01, 0x01, 0x00, 0x02

/*
// Set properties:           RF_INT_CTL_MODEM_ENABLE_1
// Number of properties:     1
// Group ID:                 0x01
// Start ID:                 0x02
// Default values:           0x00,
...
*/
#define RF_INT_CTL_MODEM_ENABLE_1 0x11, 0x01, 0x01, 0x02, 0x03
...
//                           0x04 10 01 0x01 0x98                                  # 0x11 SET_PROPERTY:
//                           0x04 10 01 0x01 0xA0                                  # 0x11 SET_PROPERTY:
// Descriptions:
...
*/
#define RF_PKT_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x00, 0x00, 0x01, 0x08, 0xFF, 0xFF, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x30
...
*/
#define RF_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0C, 0x0C, 0x30, 0x00, 0x01, 0x06, 0x80, 0x00, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x02, 0x00, 0x07, 0x05, 0xDC, 0x00, 0x01, 0x8C, 0xBA, 0x80, 0x00, 0x03
...
//   MODEM_BCR_OSR_0 - RX BCR/Slicer oversampling rate (12-bit unsigned number).
*/
#define RF_MODEM_TX_RAMP_DELAY_12_1 0x11, 0x20, 0x0C, 0x18, 0x01, 0x00, 0x08, 0x03, 0xC0, 0x00, 0x20, 0x20, 0x00, 0xE8, 0x00, 0x55
...
//   MODEM_AFC_GAIN_0 - Sets the gain of the PLL-based AFC acquisition loop, and provides miscellaneous control bits for AFC functionality.
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12_1 0x11, 0x20, 0x0C, 0x24, 0x06, 0x0C, 0xAB, 0x06, 0x06, 0x02, 0x00, 0x00, 0x00, 0x12, 0xC0, 0xC2
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_AFC_LIMITER_1_3_1 0x11, 0x20, 0x03, 0x30, 0x02, 0x3E, 0xE0
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x01, 0x79, 0x02, 0x00, 0xFF, 0x0F, 0x01, 0x18, 0x40
...
//   MODEM_CHFLT_RX2_CHFLT_COE8_7_0 - Filter coefficients for the second set of RX filter coefficients.
*/
#define RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12_1 0x11, 0x21, 0x0C, 0x0C, 0xFC, 0xFD, 0x15, 0xFF, 0x00, 0x0F, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1
...
//   FREQ_CONTROL_VCOCNT_RX_ADJ - Adjust target count for VCO calibration in RX mode.
*/
#define RF_FREQ_CONTROL_INTE_8_1 0x11, 0x40, 0x08, 0x00, 0x41, 0x0E, 0xBD, 0x0B, 0x03, 0xF0, 0x20, 0xFF
...
#define RADIO_CONFIGURATION_DATA_ARRAY { \
        ...
        0x05, RF_INT_CTL_MODEM_ENABLE_1, \
