package com.scenarioLauncher.views
{
   ...
   public class Remote2WHelpUI extends CommonPopup implements IBindingClient
   {
      ...
      public function Remote2WHelpUI()
      {
         ...
         this.remotesXmlFile = Remote2WHelpUI_remotesXmlFile;
         this.remotesXml = XML(new this.remotesXmlFile());
         this._embed_mxml__485684283 = Remote2WHelpUI__embed_mxml__485684283;
         this._embed_mxml__88066507 = Remote2WHelpUI__embed_mxml__88066507;
         this._embed_mxml__994101535 = Remote2WHelpUI__embed_mxml__994101535;
      ...
      {
         Remote2WHelpUI._watcherSetupUtil = param1;
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:Remote2WHelpUI = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(this._documentDescriptor_);
         bindings = this._Remote2WHelpUI_bindingsSetup();
         watchers = [];
         target = {};
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_scenarioLauncher_views_Remote2WHelpUIWatcherSetupUtil");
      ...
      override protected function onCreationComplete(param1:FlexEvent) : void
      {
         ...
         var _loc3_:XMLList = this.remotesXml.remotes_2w;
      ...
      private function _Remote2WHelpUI_bindingsSetup() : Array
      {
      ...
      private function _Remote2WHelpUI_bindingExprs() : void
      {
