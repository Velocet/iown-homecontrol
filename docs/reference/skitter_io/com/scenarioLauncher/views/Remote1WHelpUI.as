package com.scenarioLauncher.views
{
   ...
   public class Remote1WHelpUI extends CommonPopup implements IBindingClient
   {
      ...
      private var _577749365picto1W:Image;
      ...
      public function Remote1WHelpUI()
      {
         ...
         this.remotesXmlFile = Remote1WHelpUI_remotesXmlFile;
         this.remotesXml = XML(new this.remotesXmlFile());
         this._embed_mxml__23418909 = Remote1WHelpUI__embed_mxml__23418909;
         this._embed_mxml__88066507 = Remote1WHelpUI__embed_mxml__88066507;
         this._embed_mxml__994101566 = Remote1WHelpUI__embed_mxml__994101566;
      ...
      {
         Remote1WHelpUI._watcherSetupUtil = param1;
      }
      ...
      public function get picto1W() : Image
      {
         return this._577749365picto1W;
      }
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:Remote1WHelpUI = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(this._documentDescriptor_);
         bindings = this._Remote1WHelpUI_bindingsSetup();
         watchers = [];
         target = {};
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_scenarioLauncher_views_Remote1WHelpUIWatcherSetupUtil");
      ...
      public function set picto1W(param1:Image) : void
      {
         var _loc2_:Object = this._577749365picto1W;
         if(_loc2_ !== param1)
         {
            this._577749365picto1W = param1;
            this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"picto1W",_loc2_,param1));
         }
      }
      ...
      private function _Remote1WHelpUI_bindingsSetup() : Array
      {
      ...
      override protected function onCreationComplete(param1:FlexEvent) : void
      {
         ...
         var _loc3_:XMLList = this.remotesXml.remotes_1w;
      ...
      private function _Remote1WHelpUI_bindingExprs() : void
      {
