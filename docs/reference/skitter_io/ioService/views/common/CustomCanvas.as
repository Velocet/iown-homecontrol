package ioService.views.common
{
   import ioService.utils.GB;
   import ioService.views.common.skins.CustomCanvasSkin;
   ...
   public class CustomCanvas extends Canvas
   {
      ...
      public function CustomCanvas()
      {
         ...
         addEventListener(FlexEvent.UPDATE_COMPLETE,this.onUpdateComplete,false,0,true);
      }
