          ...
          commands = {
            {
              ...
              params = {
                { "0x02", "0x01", "0x01","0x03","0x01","0x00"}
              }
            },
            {
              baseCommand = "writePrivateWithoutPolling",
              params = {
                { "0x02", "0x01", "0x02","0x03","0xFF","0x00"}
              }
            }
          }
        }
          ...
          commands = {
            {
              baseCommand = "writePrivateWithoutPolling",
              params = {
                { "0x02", "0x00", "0x01","0x03","0x01","0x00"}
              }
            },
            {
              baseCommand = "writePrivateWithoutPolling",
              params = {
                { "0x02", "0x00", "0x02","0x03","0xFF","0x00"}
              }
            }
          }
        }
          ...
          commands = {
            {
              ...
              params = {
                { "0x01", "0x47", "0xD8","0x00","0xD1","0x00","0x00","0x00"}
              }
            }
          }
        }
          ...
          commands = {
            {
              baseCommand = "writeAlias",
              params = {
                { "0x01", "0x47", "0xD8","0x00","0xFF","0xFF","0x00","0x00"}
              },
              conversions = {
                {
                  index = 0,
