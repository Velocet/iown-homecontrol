...
function var_0_7.__call(arg_1_0, arg_1_1)
	...
	function var_1_1.modified(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		if arg_2_3 == 1 then
			if var_1_2.status ~= "pressed" then
				...
				function var_1_4.expired(arg_3_0)
		...
		elseif arg_2_3 == 0 then
			...
			if var_1_2.status ~= "released" then
				if var_1_2.status == "pressed" and var_2_0 < var_1_2.time + var_1_3 * 1000000 - 1 then
	...
	local var_1_5 = var_0_3.Monotonic()

	var_1_5:setTime(var_0_2.Monotonic(var_0_2.Elapsed(61, 0)), true)

	function var_1_5.expired(arg_4_0, arg_4_1)
	...
	function var_1_8.expired(arg_5_0)
		var_1_7.endPairing()
	end

	function var_1_7.connected()
	...
	function var_1_7.connectionPending()
		var_1_0.leds.connection.blue:setOff()
	...
	function var_1_7.localAPIPairing()
		var_1_0.leds.connection.green:setOff()
		var_1_0.leds.connection.red:setOff()
		...
		var_1_9:setTime(var_0_2.Monotonic(var_0_2.Elapsed(120, 0)), true)
		var_1_9:start()
	end

	function var_1_7.endPairing()
		...
		function var_1_9.expired(arg_14_0)
			...
			var_1_0.setFunction("connectionPending")
		end
	...
	function var_1_7.endPairingSuccess()
		...
		var_1_8:setTime(var_0_2.Monotonic(var_0_2.Elapsed(2, 0)), true)
		var_1_8:start()
	end
	...
	function var_1_0.setFunction(arg_16_0)
		...
		if var_1_7[arg_16_0] then
			if var_1_0.checkIfAllowed(var_1_0.currentMode, arg_16_0, var_1_6) then
				var_1_7[arg_16_0]()
	...
	function var_1_0.load()
		...
		function var_1_5.expired(arg_19_0, arg_19_1)
			var_1_0.setFunction("disconnected")
		end
		...
		var_1_4:setTime(var_0_2.Monotonic(var_0_2.Elapsed(var_1_3, 0)), true)
