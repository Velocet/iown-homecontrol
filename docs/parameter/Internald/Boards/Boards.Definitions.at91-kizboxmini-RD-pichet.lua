...
function var_0_8.__call(arg_1_0, arg_1_1)
	...
	function var_1_5.userInteractionConfirmation()
		...
		var_1_9:setTime(var_0_2.Monotonic(var_0_2.Elapsed(5, 0)), true)
		var_1_9:start()
	end
	...
	function var_1_0.setFunction(arg_18_0)
		...
		if arg_18_0 == "connected" or arg_18_0 == "disconnected" then
			var_1_4 = arg_18_0
		end
		...
		if var_1_5[arg_18_0] then
			if var_1_0.checkIfAllowed(var_1_0.currentMode, arg_18_0, var_0_6.defaultRailDinAllowedTransitions) then
				var_1_5[arg_18_0]()
	...
	var_1_0.name = "at91-kizboxmini-RD-pichet"
