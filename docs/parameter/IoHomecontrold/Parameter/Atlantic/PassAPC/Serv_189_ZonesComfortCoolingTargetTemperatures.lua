...
local var_0_5 = {
	...
	info = {
		...
		value = {
			type = "ay",
			data = var_0_3:buildDataWithContiniousRemapping(189, 2, 2)
		}
	}
}
local var_0_6 = var_0_1(202113213, var_0_2.access.READ, var_0_5)

var_0_6.eightZonesRefresh = var_0_4.tableDeepCopy(var_0_5)
var_0_6.eightZonesRefresh.info.value.data = var_0_3:buildDataWithContiniousRemapping(189, 8, 2)
