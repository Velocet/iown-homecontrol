...
const SQL_WASM_PATH = "../../assets/javascripts/sqliteviewer/sql-wasm.wasm";
...
function initialize() {
    ...
    // let fileReaderOpts = {readAsDefault: "ArrayBuffer", on: {load: function (e) {loadDB(e.target.result);}}};
    ...
    // } else {$("#dropzone, #dropzone-dialog").fileReaderJS(fileReaderOpts);}
    ...
    //if (loadUrlDB != null) {
        ...
        xhr.open("GET", decodeURIComponent("../../parameter/database/iohomecontrol.sqlite"), true);
        xhr.responseType = "arraybuffer";
        xhr.onload = function (e) {loadDB(this.response);};
        xhr.onerror = function (e) {setIsLoading(false);};
        xhr.send();
    //}
}
